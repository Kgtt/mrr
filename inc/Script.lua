...
if not msg.SudoUser then return"• **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(kgt..'lock_brod_Pin') then 
return "• ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
...
return '• اصدار سورس نبض : *v'..version..'* \n'
end
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/kgtpulse"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : نبض](https://t.me/kgtpulse)' ,nil,inline,msg.id_)
return false
end
...
𝙲𝙷 𖣲. :[𝙿𝚄𝙻𝚂𝙴𝙱𝙾𝚃 𖤐 ](https://t.me/Sourcekgt)
]]
end
...
"اسمي ["..Bot_Name.."] .",
"نادني ["..Bot_Name.."] .",
"ما تعرف تقرا اسمي  ["..Bot_Name.."] .",
"ما ابي اغلط في امك اسمي["..Bot_Name.."] .",
"تدلل .",
"تفضل .",
"عيوني لك .",
" نعم كيفك",
...
elseif Text== "جوجل" or Text== "بكار" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس نبض↯](https://t.me/KGTBR)")
elseif Text== "حبيبه" or Text== "ننبض" then return  sendMsg(msg.chat_id_,msg.id_,"[قلب جوجل↯](https://t.me/KGTBHH)")
elseif Text== "سورس نبض" or Text== "سورس نبض" then return  sendMsg(msg.chat_id_,msg.id_,"[احسن سورس مصري ↯](https://t.me/kgtpulse)")
elseif Text== "نبض" or Text== "نبضتي" then return  sendMsg(msg.chat_id_,msg.id_,"[آفُضلُِ بَووت،حٍمآيهـ فُي آلُِتلُِجٍرآم 𖤍](https://t.me/kgtpulsebot)")
elseif Text== "ااغاني" or Text== "الااغاني" then return  sendMsg(msg.chat_id_,msg.id_,"[@YTOOTY_BOT + اسم الاغنية]")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/kgtpulse) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/kgtpulse)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/kgtpulse)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/kgtpulse)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/kgtpulse)")
end 
end 
